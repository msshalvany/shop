      ...
      <header class="header white-bg">
            ...
            <div class="top-nav ">
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <img style="height: 50px;margin-top:-10px " class="img-thumbnail" alt="" src="{{session()->get('Admin')['image']}}">
                            <span class="username">{{session()->get('Admin')['username']}}</span>
                            <b class="caret"></b>
                        </a>
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li><a href="{{ route('logoutadmin') }}"><i class="icon-key"></i> خروج</a></li>
                        </ul>
                    </li>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a class="" href="{{ route('Product.create') }}">اضافه کردن محصول</a></li>
                        <li><a class="" href="{{ route('byedList') }}">محصولات خریداری شده</a></li>
                    </ul>
                </li>
                <li class="">
