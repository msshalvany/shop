    ...
    <header>
       ...
       get_pro_box()
        ...
        <div  class="box_shop">
            ...
            <button class="add_box_all"><a  href="{{ route('boxall', ['id'=>session()->get('User')->id]) }}">تصفیه تمام محصولات</a></button>
        </div>
        <script>
        ...
        <div style="height: 325px" class="login2" id="login2">
            <form method="POST" action="{{ route('LoginUser') }}">
                ...
                <a class="link-recovery-pasword" href="{{ route('resetassword') }}">بازیابی رمز عبو</a>
            </form>
            <script>
