...
<?php $__env->stopSection(); ?>
    ...
    <div class="login">
        <form class="form-group form_login" action="<?php echo e(route('passwordchang')); ?>" enctype="multipart/form-data"
            method="POST">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('shop.layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/madhi/Documents/shop/resources/views/shop/user/changpass.blade.php ENDPATH**/ ?>